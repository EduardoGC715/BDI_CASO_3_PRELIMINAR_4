...
SELECT CEILING(RAND(CHECKSUM(NEWID())) * 30000), CEILING(RAND(CHECKSUM(NEWID())) * 200000), CEILING(RAND(CHECKSUM(NEWID())) * 10000),
	...
	CEILING(RAND(CHECKSUM(NEWID())) * 30)/100, CEILING(RAND(CHECKSUM(NEWID())) * 500000),  GETDATE(),  GETDATE(), 'me', 'root', HASHBYTES('SHA2_256', 'hola mundo')
FROM number_sequence
OPTION (MAXRECURSION 32767);

-- Contract_terms fill variation -- 
WITH number_sequence AS (
SELECT 1 as n
UNION ALL
SELECT n+1
...
SELECT CEILING(RAND(CHECKSUM(NEWID())) * 30000), CEILING(RAND(CHECKSUM(NEWID())) * 200000), CEILING(RAND(CHECKSUM(NEWID())) * 10000),
	...
	CEILING(RAND(CHECKSUM(NEWID())) * 30)/100, CEILING(RAND(CHECKSUM(NEWID())) * 2000000000)/CEILING(RAND(CHECKSUM(NEWID())) * 10000), 
	CEILING(RAND(CHECKSUM(NEWID())) * 500000), CEILING(RAND(CHECKSUM(NEWID())) * 10)/100,
