...
exports.data_esencial_pooling = void 0;
...
var data_esencial_pooling = /** @class */ (function () {
    function data_esencial_pooling() {
        this.pool = new sql.ConnectionPool(sqlConfig);
        this.log = new common_1.Logger();
    }
    data_esencial_pooling.getInstance = function () {
    ...
    data_esencial_pooling.prototype.getProducers = function () {
    ...
    return data_esencial_pooling;
}());
exports.data_esencial_pooling = data_esencial_pooling;
